  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-3">
        <div className="flex flex-col justify-center space-y-4 xl:col-span-1">
          <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">123 Real Estate Blvd, New York, NY 10001</p>
              </div>
            </div>
          </div>
            ...
            <TabsContent value="map" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Visit our office at 123 Real Estate Blvd, New York, NY 10001</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="aspect-video w-full rounded-md border bg-muted flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <p className="font-medium">123 Real Estate Blvd, New York, NY 10001</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
